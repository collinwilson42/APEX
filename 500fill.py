"""
US500 FILL - US500Z25 Database Backfill (S&P 500 Futures)
=========================================================
Fills US500Z25_intelligence.db with 50,000 1M and 50,000 15M bars

Usage: py -3.11 500fill.py
"""
...
def main():
    print("\n" + "=" * 70)
    print(f"US500 FILL - {SYMBOL_NAME}")
